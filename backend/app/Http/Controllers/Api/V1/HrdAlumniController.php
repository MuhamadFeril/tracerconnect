...
class HrdAlumniController extends Controller
{
    /**
     * Browse/search alumni who have applied to the hrd's job vacancies.
     * IDOR fix: scoped to only alumni with applications on the hrd's jobs.
     */
    public function index(Request $request): JsonResponse
    {
        ...
        $alumni = Alumni::query()
            ...
            // IDOR fix: only show alumni who applied to this hrd's jobs
            ->whereHas('user.jobApplications.vacancy', fn ($q) => $q->where('created_by', $hrdId))
    ...
    /**
     * Detailed alumni profile for the hrd.
     * IDOR fix: only viewable if the alumni applied to the hrd's jobs.
     */
    public function show(Request $request, string $alumniId): JsonResponse
    {
        ...
        // IDOR fix: verify this alumni applied to one of the hrd's jobs
