...
/// Ringkasan dashboard HRD dari endpoint /hrd/dashboard.
class HrdDashboardData {
  ...
  factory HrdDashboardData.fromJson(Map<String, dynamic> json) {
    return HrdDashboardData(
...
final hrdDashboardProvider =
    FutureProvider<HrdDashboardData>((ref) async {
  final api = ApiClient.instance;
  final env = await api.getEnvelope('/hrd/dashboard');
  return HrdDashboardData.fromJson(env.data as Map<String, dynamic>);
});
