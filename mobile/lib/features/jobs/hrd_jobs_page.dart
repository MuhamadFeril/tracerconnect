...
///
/// Menampilkan daftar lowongan yang dibuat oleh HRD yang sedang login,
/// dengan aksi untuk menambah, mengedit, menghapus, dan melihat pelamar.
class HrdJobsPage extends ConsumerStatefulWidget {
  const HrdJobsPage({super.key});

  @override
  ConsumerState<HrdJobsPage> createState() => _HrdJobsPageState();
}

class _HrdJobsPageState extends ConsumerState<HrdJobsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => context.push('/hrd-jobs/new'),
...
class _HrdJobCard extends StatelessWidget {
  final JobVacancy job;

  const _HrdJobCard({required this.job});
          ...
          Row(
            children: [
              ...
              Expanded(
                child: OutlinedButton.icon(
                  onPressed: () =>
                      context.push('/hrd-jobs/${job.id}/edit'),
