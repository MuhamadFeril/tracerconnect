...
/// Halaman formulir untuk membuat atau mengedit lowongan kerja (hrd).
class HrdJobFormPage extends ConsumerStatefulWidget {
  /// ID lowongan yang akan diedit. `null` = buat baru.
  final String? jobId;

  const HrdJobFormPage({super.key, this.jobId});

  bool get isEditing => jobId != null;

  @override
  ConsumerState<HrdJobFormPage> createState() =>
      _HrdJobFormPageState();
}

class _HrdJobFormPageState extends ConsumerState<HrdJobFormPage> {
