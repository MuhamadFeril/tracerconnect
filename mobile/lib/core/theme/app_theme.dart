...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF172D6D);
  static const Color primaryLight = Color(0xFFEEF2FB);
...
/// Tema Material 3 aplikasi — light-first, navy sebagai seed color.
class AppTheme {
  AppTheme._();
