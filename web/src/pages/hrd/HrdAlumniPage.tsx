...
import { useHrdAlumni, useDepartments, useGraduationYears } from '../../hooks/queries'
...
export function HrdAlumniPage() {
  ...
  const { data, isPending, isError, refetch } = useHrdAlumni({
