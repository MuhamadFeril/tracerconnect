  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard label="Total Alumni" value={data.total_alumni.toLocaleString('id-ID')} icon={Users} tone="indigo" delay={0} />
        <StatCard label="Responden" value={data.total_respondents.toLocaleString('id-ID')} sub="Respons tersubmit" icon={ClipboardList} tone="sky" delay={80} />
        <StatCard label="Response Rate" value={`${data.response_rate}%`} sub="Alumni yang mengisi" icon={TrendingUp} tone="emerald" delay={160} />
        <StatCard label="Bekerja" value={`${workingRate}%`} sub={`${working} alumni bekerja`} icon={Briefcase} tone="amber" delay={240} />
      </div>
