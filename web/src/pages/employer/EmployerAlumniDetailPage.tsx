...
import { useEmployerAlumniDetail } from '../../hooks/queries'
...
export function EmployerAlumniDetailPage() {
  const { id } = useParams<{ id: string }>()
  const { data: alumni, isPending, isError, refetch } = useEmployerAlumniDetail(id ?? null)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link to="/employer/alumni" className="rounded-lg p-2 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600">
