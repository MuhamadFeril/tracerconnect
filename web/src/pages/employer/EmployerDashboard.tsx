...
import { useEmployerDashboard } from '../../hooks/queries'
...
export function EmployerDashboard() {
  const { data, isPending, isError, refetch } = useEmployerDashboard()

  if (isPending) return <LoadingState label="Memuat dashboard employer…" />
  if (isError || !data) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold tracking-tight text-slate-900 sm:text-2xl">Dashboard Employer</h1>
        ...
        <div className="animate-fade-in-up lg:col-span-3" style={{ animationDelay: '120ms' }}>
          <Card>
            <CardHeader
              ...
              actions={
                <Link to="/employer/lamaran" className="inline-flex items-center gap-1 text-xs font-medium text-indigo-600 hover:text-indigo-500">
      ...
      <div className="animate-fade-in-up" style={{ animationDelay: '280ms' }}>
        <Card>
          <CardHeader
            ...
            actions={
              <Link to="/employer/lowongan" className="inline-flex items-center gap-1 text-xs font-medium text-indigo-600 hover:text-indigo-500">
